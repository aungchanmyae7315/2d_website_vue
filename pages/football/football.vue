...
<div class="f_main">
  <el-main class="main_page twod_home">
    ...
    <el-header>
      ...
      <img
        src="~static/images/twod_logo.png"
      ...
      <div class="hideScrollBar">
          ...
          <div class="demo-type">
            <el-row>
              <el-col :span="21">
                <nuxt-link
                  :to="
                    `${$t('/edit_profile_index')}?lang=${$store.state.locale}`
                  "
                >
                ...
                <div class="avatar_text">
                  <ul>
                    <nuxt-link
                      :to="
                        `${$t('/edit_profile_index')}?lang=${
                          $store.state.locale
                        }`
                      "
                    >
                      <li style="color:#fff">
                        <span v-if="this.profile.name == null">{{
                          this.profile.phone
                        }}</span>
                    ...
                    <nuxt-link
                      :to="`${$t('/wallet')}?lang=${$store.state.locale}`"
                    >
                      <li class="amount_mmk">
        ...
        <h3 class="run_bar">
          <div class="scroll-left">
            <p>
              <img
                src="~static/images/slide_inner_icon.png"
                alt=""
                class="slide_inner_icon"
              />
                      ...
                      <el-row>
                        <el-col>
                          <div class="teaminner_01">
                            ...
                            <img
                              :src="football_info.away_team.logo"
                              alt=""
                          ...
                          <div class="match" v-if="football_info.status == 1">
                            ...
                            <div class="teaminner_01">
                              <p class="t_name">{{football_info.home_team.name}} </p>
                              <img
                              :src="football_info.home_team.logo"
                              alt=""
                              class="team_logo team_02"
                            />
                              <p class="result">
                        ...
                        <div class="match">
                          <div class="teaminner_01">
                            <p class="t_name">{{complete_info.home_team.name}}</p>
                              <img
                              :src="complete_info.home_team.logo"
                              alt=""
                              class="team_logo team_02"
                            />
                            <p class="result">
                            ...
                            <img
                              :src="complete_info.away_team.logo"
                              alt=""
                              class="team_logo team_02"
                            />
                    ...
                    <el-row>
                      <el-col>
                        <div class="teaminner_01">
                          ...
                          <img
                            :src="upcoming_info.home_team.logo"
                            alt=""
                            class="team_logo team_1"
                          />
                          <p class="t_name">{{upcoming_info.play_at}}</p>
                          <img
                            :src="upcoming_info.away_team.logo"
                            alt=""
                            class="team_logo team_02"
                          />
