<template>
  <el-main class="main_page twod_home">
    ...
    <div class="longText" id="hidingScrollBar">
      <div class="hideScrollBar1">
        <div class="padding-adjust">
          <div class="card_one card_one1">
            <div class="left">
              <div class="team team_1">
                Team Name
                <div class="team_img" style="">
                  <img src="~static/images/chelsea.png" alt="" />
                </div>
              </div>
              <div class="vs">
                vs
              ...
              <div class="team team_2">
                <div class="team_img">
                  <img
                    src="~static/images/manchester.png"
                    alt=""
                    class="twod_card"
                  />
                </div>
...
export default {
  ...
  methods: {
    ...
    async getKweeLiveData() {
      this.$axios.get("/luke/kwee_live").then(response => {
    ...
    itvKweeLiveData() {
      this.kweeliveItvId = setInterval(
        function() {
          this.getKweeLiveData();
        }.bind(this),
        3000
    ...
    async getDataresult() {
      this.$axios.get("/v2/v1/twod-result/live").then(response => {
  ...
  created() {
    ...
    this.serverCurTimeItvId = setInterval(
      () => this.ServerCurrentTime(),
      1 * 1000
    );

    if (
      this.currentTime > this.morningTime_9_30 &&
      this.currentTime < this.time_12_00
    ) {
    } else if (
      this.currentTime > this.time_12_00 &&
      ...
      this.currentTime > this.time_01_00 &&
      this.currentTime < this.time_04_30
    ) {
    } else if (
      this.currentTime > this.time_04_30 &&
      this.currentTime < this.morningTime_9_30
