...
<!--
        ...
        <h3 class="run_bar">
          ...
          <div class="choose_2d_3d" data-aos="fade-up" data-aos-duration="700">
            <el-row>
              <el-col :span="8">
                <nuxt-link :to="`${$t('/football/goal')}?lang=${$store.state.locale}`">
              ...
              <el-col :span="8">
                 <nuxt-link :to="`${$t('/football/body')}?lang=${$store.state.locale}`">
                        <div class="card_one font-color" style="margin-right:20px;">
                         Body
                         </div>
              ...
              <el-col :span="8">
                 <nuxt-link :to="`${$t('/football/maungg')}?lang=${$store.state.locale}`">
