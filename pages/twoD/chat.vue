    ...
    <div class="main_container live_chat">
        <el-header class="header">
            <!-- <nuxt-link  :to="`${$t('/')}?lang=${$store.state.locale}`"> -->
                <el-page-header title="" @back="goBack"  content="Sein Lucky 2D Live Chat">
                    </el-page-header>
            <!-- </nuxt-link> -->
...
import NewMessagetwod from "@/components/NewMessage_2d";
   ...
   this.itvKweeLiveData();
    ...
    created() {
      ...
      setInterval(() => this.ServerCurrentTime(), 1 * 1000);
        ...
        let ref = db.collection("messages_2d")
        .orderBy("timestamp")
        .limitToLast(500);
