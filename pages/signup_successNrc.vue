                 ...
                 <div class="longText" id="hidingScrollBar">
                    ...
                    <!-- <img src="~static/images/refel_page/refel_img_one.png" class="refel_img"> -->
                        ...
                        <el-card class="box-card">
                            ...
                            <img src="~static/images/have_nrc.jpg" alt="" class="signup_show_img">
                            <p>ဤဖုန်းသည် အခြားအကောင့်တစ်ခုဖြင့်မှတ်ပုံတင် ထားပြီးပါသဖြင့် ရည်ညွှန်းကုဒ်ထပ်ဖြည့်၍မရနိုင်ပါ။</p>
